...
## print the value associated with text"
    for catfact in r.json()["all"]:
        if catfact.get.int("upvotes") > 2:
            print(catfact.get("upvotes"))  # the .get() method returns NONE if key not found

# I was trying to figure out how to just print upvotes greater than 2 before I ran out of time
